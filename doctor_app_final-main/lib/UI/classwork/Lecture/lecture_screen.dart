...
class LectureScreen extends StatefulWidget {
  ...
  const LectureScreen({this.courseId, Key? key}) : super(key: key);

  @override
  State<LectureScreen> createState() => _AssignmentsScreenState();
}

class _AssignmentsScreenState extends State<LectureScreen> {
  File? _selectedFile;
  Uint8List? bytes;
  GlobalKey<FormState> lectureFormKey = GlobalKey<FormState>();
  String? downloadUrl = '';
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    defaultTextForm(
                      controller: provider.lectureTitleController,
                    ...
                    defaultButton(
                      ...
                      function: () async {
                        if (lectureFormKey.currentState!.validate()) {
                          await provider.uploadMaterial(
                            provider.lectureTitleController.text,
                            widget.courseId,
